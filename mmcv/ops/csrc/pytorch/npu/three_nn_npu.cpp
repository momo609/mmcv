...
void three_nn_forward_npu(int b, int n, int m,
                          const Tensor unknown, const Tensor known, Tensor dist2, Tensor idx) {
...
void three_nn_forward_impl(int b, int n, int m,
                          const Tensor unknown, const Tensor known, Tensor dist2, Tensor idx);
