...
void dynamic_voxelize_forward_npu(const at::Tensor &points, at::Tensor &coors,
    ...
    int32_t grid_x_f = std::round((coors_max_x - coors_min_x) / voxel_x);
    int32_t grid_y_f = std::round((coors_max_y - coors_min_y) / voxel_y);
    int32_t grid_z_f = std::round((coors_max_z - coors_min_z) / voxel_z);
